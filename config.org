...
- [[#one-liners][One Liners]]
  ...
  - [[#zoom][Zoom]]
  - [[#enable-word-count][Enable Word Count]]
  - [[#disable-unnecessary-new-os-windows][Disable unnecessary new os windows]]
  - [[#calendar][Calendar]]
  - [[#sets-olivettis-body-width][Sets olivettis body width]]
  - [[#default-bib-file][Default Bib File]]
  - [[#super-save][Super-save]]
  - [[#opening-large-files][Opening Large Files]]
  - [[#disable-hl-line-mode][Disable hl-line-mode]]
  - [[#make-the-title-bar-text-empty][Make the title bar text empty]]
  - [[#open-olivetti-mode][Open olivetti Mode]]
- [[#pandoc][Pandoc]]
...
- [[#org][Org]]
  ...
  - [[#change-the-look-of-org-agenda-to-do-view][Change the look of org-agenda to-do view.]]
...
- [[#make-emacs-silent][Make emacs silent]]
- [[#presentation][Presentation]]
  - [[#make-images-adjust-to-width][Make images adjust to width]]
  - [[#biu][bi"u]]
- [[#startup][Startup]]
  - [[#maximize-on-startup-using-rectangle][Maximize on startup using Rectangle]]
- [[#notes-for-myself][Notes for myself]]
  ...
  - [[#disabling-tilde-outside-of-doom-emacs][Disabling tilde outside of doom emacs]]
  - [[#using-emacs-plus][Using emacs-plus]]
  - [[#to-only-show-todo-list-on-custom-agenda][To only show todo list on custom agenda]]
- [[#testing][Testing]]
