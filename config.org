...
- [[#calendar][Calendar]]
  - [[#make-calendar-start-on-monday][Make calendar start on monday]]
- [[#zoom][Zoom]]
- [[#pandoc][Pandoc]]
- [[#org][Org]]
...
brew install emacs-plus --with-native-comp --with-xwidgets --with-imagemagick --with-retro-emacs-logo-icon
#+end_src
*** Background service
#+begin_src shell :tangle no
